...
##########################################################################################################
    ...
    async def setup(self,ctx):
        ...
        channel = await guild.create_text_channel('zenith-private', overwrites=overwrites)
        ...
        e.set_author(name="BuddyIsOp#6056")#,icon_url='https://cdn.discordapp.com/avatars/749550694469599233/9abccc9f94b2f9e01cc2e788ff3c8cf0.webp?size=1024'
 ...
 #           raise expectations.NotSetup
  ...
  #      await ctx.send(f'{emote.tick} | Successfully Setuped Automeme Channel To {channel.mention}')
    ...
    async def config_autorole_set_human(self,ctx,role:discord.Role):
        ...
        if data is False:
            raise expectations.NotSetup
        botrole = discord.utils.get(ctx.guild.roles,name="zenith")
